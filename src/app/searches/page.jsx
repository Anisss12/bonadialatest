    ...
    <div className={styles.searches}>
      <div className={styles.searchBar}>
        ...
        <input
          ref={inputRef}
          type="text"
          placeholder="Search cloth, category..."
          style={{ color: "white" }}
        />
        <Search
          size={32}
      ...
      <h5 className={styles.recntSearchh5}>RECENT SEARCHES</h5>
      <div className={styles.recentSearchContainer}>
        {images.map((item, index) => (
          <div key={index} className={styles.circleCard}>
            <Image src={item} alt="image" width={500} height={500}></Image>
            <h2>Pant</h2>
          </div>
        ))}
      </div>

      <div className={styles.wishlisted}>
        <h5>ITEMS IN YOUR WISHLIST</h5>
        <div className={styles.wishcards}>
          {images.map((item, index) => (
            <WishCard display={"none"} key={index} item={item}></WishCard>
          ))}
        </div>
      </div>
    </div>
